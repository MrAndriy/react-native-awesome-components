...
import { StyleSheet, Text, View, Image, Dimensions, Animated, ImageRequireSource } from 'react-native'
...
const Ticker = ({ scrollOffsetAnimatedValue, positionAnimatedValue }: { scrollOffsetAnimatedValue: Animated.Value; positionAnimatedValue: Animated.Value }) => {
...
const Pagination = ({ scrollOffsetAnimatedValue, positionAnimatedValue }: { scrollOffsetAnimatedValue: Animated.Value; positionAnimatedValue: Animated.Value }) => {
  const inputRange = [0, data.length]
...
export default function HeadphonesCarouselExample() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image style={styles.logo} source={require('@/assets/images/ue_black_logo.png')} />
      <Pagination scrollOffsetAnimatedValue={scrollOffsetAnimatedValue} positionAnimatedValue={positionAnimatedValue} />
      <Ticker scrollOffsetAnimatedValue={scrollOffsetAnimatedValue} positionAnimatedValue={positionAnimatedValue} />
    </View>
  )
}
...
const styles = StyleSheet.create({
  ...
  logo: {
    ...
    left: 10,
    bottom: 10,
    transform: [{ translateX: -LOGO_WIDTH / 2 }, { translateY: -LOGO_HEIGHT / 2 }, { rotateZ: '-90deg' }, { translateX: LOGO_WIDTH / 2 }, { translateY: LOGO_HEIGHT / 2 }],
  },
  pagination: {
    position: 'absolute',
    right: 20,
